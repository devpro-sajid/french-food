...
const Footer = () => {
    return (
        ...
        <div className=" bg-amber-50 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
            <footer className="boxed-container">
                <div className="flex items-center justify-center border-b-2 border-neutral-200 pt-0 pb-6 pl-6 pr-6 dark:border-neutral-500 lg:justify-between">
                    ...
                    <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div className="">
                            <h6
                                ...
                                <img className='w-8 mr-3' src="https://i.ibb.co/bKnRr2F/feeding.png" alt="" />
                                French Food Lounge
                            </h6>
                            <p>
                ...
                {/* <!--Copyright section--> */}
                <div className="bg-amber-200 p-6 text-center dark:bg-neutral-700 rounded-lg">
                    <span>© 2023 Copyright/All Rights Reserved By </span>
